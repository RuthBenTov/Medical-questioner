...
navigate('/QuestionTwoForMale');
    ...
    return (
        ...
        <div>
        <img src={imageQuestionOneForMale1} onClick={badlyHappenClickHandlerOnQuestionOneForMaleImage}/>
        <Link to={"/MaleOrFemalePage"}title="BACK">
        <PossibilityOfBackTothetweenQuestions/></Link>
        <Link to={"/QuestionTwoForMale"} title="Next">
        <PossibilityOfNextTothetweenQuestions/></Link>
        </div>
        <div>
        <img src={imageQuestionOneForMale2} onClick={wellHappenClickHandlerOnQuestionOneForMaleImage}/>
            <br/>
            <Link to={""} title="There are two images representing experiences while drinking liquids.Choose the image that best represents your experience. " ><label>
