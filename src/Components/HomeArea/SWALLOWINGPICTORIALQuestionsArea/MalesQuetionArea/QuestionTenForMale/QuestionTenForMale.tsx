...
function QuestionTenForMale(): JSX.Element {
    ...
    return (
        ...
        <div>
         <img src={imageQuestionTenForMale1} onClick={badlyHappenClickHandlerOnQuestionTenForMaleImage}/> 
          <br/>
           <Link to={"/QuestionNineForMale"} title="BACK"><label>
        <PossibilityOfBackTothetweenQuestions/>
        </label></Link>
         <Link to={""} title="NEXT"><label>
        <PossibilityOfNextTothetweenQuestions/>
    </label></Link>
     </div>
     <div>
         <img src={imageQuestionTenForMale2} onClick={wellHappenClickHandlerOnQuestionTenForMaleImage}/>
         <br/>
          <Link to={""} title="
        There are two images representing experiences of feeling anxious about swallowing.
         Choose the image that best represents your experience."><label>
          <svg className="SvgQuestionNineForMale Box"  width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
