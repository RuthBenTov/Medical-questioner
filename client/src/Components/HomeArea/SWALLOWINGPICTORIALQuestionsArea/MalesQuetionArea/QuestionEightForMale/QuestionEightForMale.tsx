...
function QuestionEightForMale(): JSX.Element {
    ...
    return (
        <div className="QuestionEightForMale">
             <div> 
         <img src={imageQuestionEightForMale1} onClick={badlyHappenClickHandlerOnQuestionEightForMaleForMaleImage}/>
         <br/> 
        <Link to={"/QuestionSevenForMale"} title="BACK"><label>
            <PossibilityOfBackTothetweenQuestions/>
            </label></Link>
        
        <Link to={"/QuestionNineForMale"} title="NEXT"><label>
            <PossibilityOfNextTothetweenQuestions/>
            </label></Link>
        </div>
        <div>
           
            <img src={imageQuestionEightForMale2} onClick={wellHappenClickHandlerOnQuestionEightForMaleForMaleImage}/>
            <br/>
             <Link to={""} title="
