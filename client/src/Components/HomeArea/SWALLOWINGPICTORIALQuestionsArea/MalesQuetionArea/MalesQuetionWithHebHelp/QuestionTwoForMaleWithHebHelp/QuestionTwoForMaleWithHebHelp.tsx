...
function QuestionTwoForMaleWithHebHelp(): JSX.Element {
    ...
    return (
        <div className="QuestionTwoForMaleWithHebHelp">
        <div>
        <img src={imageQuestionTwoForMaleWithHebHelp1} onClick={badlyHappenClickHandlerOnQuestionTwoForMaleWithHebHelpImage}/>
        <Link to={"/QuestionOneForMaleWithHebHelp"}title="חזור">
        <PossibilityOfBackTothetweenQuestions/>
        </Link>
        <Link to={"/QuestionThreeForMaleWithHebHelp"} title="הבא">
        <PossibilityOfNextTothetweenQuestions/>
        </Link>
        </div>
        <div>
        <img src={imageQuestionTwoForMaleWithHebHelp2} onClick={wellHappenClickHandlerOnQuestionTwoForMaleWithHebHelpImage}/>
            <br/>
