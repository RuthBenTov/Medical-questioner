...
function QuestionOneForMaleWithHebHelp(): JSX.Element {
    ...
    return (
        <div className="QuestionOneForMaleWithHebHelp">
             <div>
        <img src={imageQuestionOneForMaleWithHebHelp1} onClick={badlyHappenClickHandlerOnQuestionOneForMaleWithHebHelpImage}/>
        <Link to={"/MaleOrFemalePageWithHeb"}title="חזור">
        <PossibilityOfBackTothetweenQuestions/>
        </Link>
        <Link to={"/QuestionTwoForMaleWithHebHelp"} title="הבא">
        <PossibilityOfNextTothetweenQuestions/>
        </Link>
        </div>
        <div>
        <img src={ imageQuestionOneForMaleWithHebHelp2} onClick={wellHappenClickHandlerOnQuestionOneForMaleWithHebHelpImage}/>
            <br/>
            <Link to={""} title="לפניך מוצגות שתי תמונות המייצגות חוויה שקשורה ליכולת שלך לבלוע נוזלים
