...
function QuestionTenForMaleWithHebHelp(): JSX.Element {
    ...
    return (
        <div className="QuestionTenForMaleWithHebHelp">
                  <div>
        <img src={ imageQuestionTenForMaleWithHebHelp1} onClick={badlyHappenClickHandlerOnQuestionTenForMaleWithHebHelpImage}/>
        <br/>
        <Link to={"/QuestionNineForMaleWithHebHelp"}title="חזור">
        ...
        <div>
        <img src={ imageQuestionTenForMaleWithHebHelp2} onClick={wellHappenClickHandlerOnQuestionTenForMaleWithHebHelpImage}/>
            <br/>
            <Link to={""} title="
