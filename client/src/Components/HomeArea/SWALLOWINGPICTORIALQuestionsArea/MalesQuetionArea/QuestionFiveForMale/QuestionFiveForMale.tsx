...
function QuestionFiveForMale(): JSX.Element {
    ...
    return (
        ...
        <div>
        <img src={ imageQuestionFiveForMale1} onClick={badlyHappenClickHandlerOnQuestionFiveForMaleImage}/>
        <br/>
        <Link to={"/QuestionFourForMale"} title="BACK"><label>
            <PossibilityOfBackTothetweenQuestions/>
        </label></Link>
        <Link to={"/QuestionSixForMale"}title="NEXT"><label>
            <PossibilityOfNextTothetweenQuestions/>
        </label></Link>
        </div>
        <div>
            <img src={imageQuestionFiveForMale2} onClick={wellHappenClickHandlerOnQuestionFiveForMaleImage}/>
            <br/>
            ...
            <svg className="SvgQuestionFiveForMale Box"  width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
