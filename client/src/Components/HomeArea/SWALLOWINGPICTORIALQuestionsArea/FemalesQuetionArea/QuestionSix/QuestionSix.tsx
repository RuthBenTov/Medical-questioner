...
function QuestionSix(): JSX.Element {
    ...
    return (
        <div className="QuestionSix">
            <div>
            <img src={ImageQuestionSix1} onClick={badlyHappenClickHandlerOnQuestionSixForFemaleImage}/>
            <br/>
            <Link to={"/QuestionFive"} title="NEXT"><label>
                <PossibilityOfBackTothetweenQuestions/>
            </label></Link>
            <Link to={"/QuestionSeven"} title="NEXT"><label>
                <PossibilityOfNextTothetweenQuestions/>
            </label></Link>
           </div>
           <div>
           <img src={ImageQuestionSix2} onClick={wellHappenClickHandlerOnQuestionSixForFemaleImage}/>
           <br/>
            ...
            <svg className="SvgQuestionSix Box"  width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
