...
function QuestionNineWithHebHelp(): JSX.Element {
    ...
    return (
        <div className="QuestionNineWithHebHelp">
        <div> 
      <img src={ImageQuestionNineWithHebHelp1} onClick={badlyHappenClickHandlerOnQuestionNineWithHebHelpForFemaleImage}/>
      <br/>
      <Link to={"/QuestionEightWithHebHelp"} title="חזור"><label>
      ...
      <div>
        <img src={ImageQuestionNineWithHebHelp2}  onClick={wellHappenClickHandlerOnQuestionNineWithHebHelpForFemaleImage}/>
        <br/>
        <Link to={""} title="
