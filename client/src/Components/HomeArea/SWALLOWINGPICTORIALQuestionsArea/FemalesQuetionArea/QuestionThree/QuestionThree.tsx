 ...
 function  badlyHappenClickHandlerOnQuestionThreeForFemaleImage():void{
    ...
    return (
        <div className="QuestionThree">
            <div>
            <img src={ImageQuestionThree1} onClick={badlyHappenClickHandlerOnQuestionThreeForFemaleImage}/>
            <br/>
            <Link to={"/QuestionTwo"} title="BACK"><label>
                <PossibilityOfBackTothetweenQuestions/>
            </label></Link>
            
            <Link to={"/QuestionFour"} title="NEXT"><label>
                <PossibilityOfNextTothetweenQuestions/>
            </label></Link>
           </div>
           <div>
            <img src={ImageQuestionThree2} onClick={wellHappenClickHandlerOnQuestionThreeForFemaleImage}/>
            <br/>
            ...
            <svg className="SvgQuestionThree Box"  width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
