...
function QuestionEight(): JSX.Element {
    ...
    return (
        <div className="QuestionEight">
            <div>
            <img src={ImageQuestionEight1} onClick={badlyHappenClickHandlerOnQuestionEightForFemaleImage}/>
            <br/>
            <Link to={"/QuestionSeven"} title="BACK"><label>
                <PossibilityOfBackTothetweenQuestions/>
            </label></Link>
            <Link to={"/QuestionNine"} title="NEXT"><label>
                <PossibilityOfNextTothetweenQuestions/>
            </label></Link>
           </div>
           <div>
           <img src={ImageQuestionEight2} onClick={wellHappenClickHandlerOnQuestionEightForFemaleImage}/>
           <br/>
            <Link to={""} title="There are two images representing experiences of pain when swallowing.Choose the image that best represents your experience."><label>
            <svg className="SvgQuestionEight Box"  width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
