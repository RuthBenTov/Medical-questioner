...
function MaleOrFemalePage(): JSX.Element {
    ...
    return (
        <div className="MaleOrFemalePage">
            <div>
           <img src={Male}  onClick={clickHandlerOnMaleImage} />
            <Link to={""} title="Next">
           </Link>
           </div>
           <div>
            <img src={female} onClick={clickHandlerOnFemaleImage}/>
            <br/>
            <Link to={""} title="There are two images represeting genders Choose the gender that represents you."><label>
